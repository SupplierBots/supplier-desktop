...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Logger\", function() { return Logger; });\n/* harmony import */ var _Users_heljas_Documents_SafeDrop_Dev_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js\");\n/* harmony import */ var fs_extra__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! fs-extra */ \"fs-extra\");\n/* harmony import */ var fs_extra__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(fs_extra__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! electron */ \"electron\");\n/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(electron__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! moment */ \"moment\");\n/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_3__);\n\n\n\n\n\nconst parseData = value => {\n  try {\n    return JSON.parse(value !== null && value !== void 0 ? value : '{}');\n  } catch (e) {\n    return value;\n  }\n};\n\nconst getResponseContent =\n/*#__PURE__*/\nfunction () {\n  var _ref = Object(_Users_heljas_Documents_SafeDrop_Dev_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(function* (response) {\n    try {\n      return yield response.json();\n    } catch {\n      return yield response.text();\n    }\n  });\n\n  return function getResponseContent(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nclass Logger {\n  constructor(id, page) {\n    var _this = this;\n\n    this.id = id;\n    this.page = page;\n    this.stream = void 0;\n\n    this.reportRequest = req => {\n      const url = req.url();\n      const data = req.postData();\n      const headers = req.headers();\n      const contentType = headers['content-type'];\n      if (!contentType) return;\n\n      if ( true && /(supremenewyork|commerce|d17ol771963kd3)/.test(url) && !url.includes('mobile_stock') && (contentType.includes('json') || contentType.includes('form'))) {\n        this.writeObject({\n          message: `${req.method()} ${req.url()}`,\n          headers: req.headers(),\n          data: parseData(data)\n        });\n      }\n    };\n\n    this.reportResponse =\n    /*#__PURE__*/\n    function () {\n      var _ref2 = Object(_Users_heljas_Documents_SafeDrop_Dev_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(function* (response) {\n        const url = response.url();\n\n        if ( true && /(supremenewyork|commerce|d17ol771963kd3)/.test(url) && !url.includes('mobile_stock')) {\n          const headers = response.headers();\n          const contentType = headers['content-type'];\n\n          if (contentType.includes('json') || contentType.includes('form')) {\n            const res = yield getResponseContent(response);\n\n            _this.writeObject({\n              message: `RESPONSE ${response.status()} ${response.url()}`,\n              headers,\n              response: res\n            });\n          } else if (contentType.includes('javascript') || contentType.includes('wasm')) {\n            const log = {\n              message: `Detected new file!`,\n              file: response.url()\n            };\n\n            _this.writeObject(log, false);\n          }\n        }\n      });\n\n      return function (_x2) {\n        return _ref2.apply(this, arguments);\n      };\n    }();\n\n    this.writeObject =\n    /*#__PURE__*/\n    function () {\n      var _ref3 = Object(_Users_heljas_Documents_SafeDrop_Dev_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(function* (message, includeCookies = true) {\n        message.time = moment__WEBPACK_IMPORTED_MODULE_3___default()().format('kk:mm:ss:SSS');\n\n        if (includeCookies) {\n          const cookies = yield _this.page.cookies('https://www.supremenewyork.com/');\n          const blacklisted = ['_utm', 'js-address', 'mixpanel'];\n          message.cookies = cookies.filter(({\n            name\n          }) => !blacklisted.some(b => name.includes(b)));\n        }\n\n        try {\n          _this.stream.write('\\n' + JSON.stringify(message, null, 1));\n        } catch {}\n      });\n\n      return function (_x3) {\n        return _ref3.apply(this, arguments);\n      };\n    }();\n\n    this.writeString = (message, includeCookies = true) => {\n      this.writeObject({\n        message\n      }, includeCookies);\n    };\n\n    this.stream = fs_extra__WEBPACK_IMPORTED_MODULE_1___default.a.createWriteStream(`${electron__WEBPACK_IMPORTED_MODULE_2__[\"app\"].getAppPath()}/logs/${this.id}${moment__WEBPACK_IMPORTED_MODULE_3___default()().format('-kk-mm-ss')}.log`);\n  }\n\n}\n\n\n\n//# sourceURL=webpack:///./src/main/bot/supreme/Logger.ts?");
